...
> [!NOTE]
> Описание соответствует **v0.4.0 от 22 сентября 2026 года** — полному development-выпуску
> с Android APK, CPU server installer, SBOM и контрольными суммами. Пакеты подписаны
> development key и опубликованы как [предварительный релиз](https://github.com/Dakstar-cool/AutPlay/releases/tag/v0.4.0).
