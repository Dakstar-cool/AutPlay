...
Загрузчик сохраняет файлы отдельно: добавление в медиатеку или Vault остаётся самостоятельным
действием. Наличие адаптера не гарантирует доступность источника или нахождение всех треков.
