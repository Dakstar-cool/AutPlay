...
| Удаление аккаунта, 18 сентября | Сервер: 30 дней на отмену, запрет удаления последнего OWNER, окончательная очистка и независимый журнал для восстановления базы. Android-интерфейс удаления и восстановление старых незавершённых процессов ещё открыты. [Отчёт и настройка журнала](docs/release/ADMIN_ACCOUNT_DELETION_2026_09_18.md) |
