...
>
> **Production-кандидат:** [v1.0.0](docs/release/RELEASE_NOTES_1.0.0.md) подготовлен,
> но не опубликован и не развёрнут. Последующие сборки до 1.0.5 проверялись на M52 как
> тестовые; они не заменяют квалификацию точного production-релиза на A55.
> [Оставшиеся проверки](docs/operations/PRODUCTION_READINESS_PLAN.md) включают
> повторную проверку поиска и доступности после замечаний на M52.
...
- **[v1.0.0 — production-кандидат](docs/release/RELEASE_NOTES_1.0.0.md).** Подготовлены
  исходники, production-подпись и аудит, связывающий APK с образом сервера. На M52 прошли
  привязка, локальное и офлайн-воспроизведение. Поздние тестовые сборки M52 до 1.0.5
  содержат дополнительные исправления; они не опубликованы как production-релиз.
  Нужны повторная проверка поиска и доступности, полный серверный gate и проверка
  точного APK на A55 с точным образом сервера.
