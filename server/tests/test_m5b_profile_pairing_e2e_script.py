...
def _load_script() -> ModuleType:
    ...
    try:
        return importlib.import_module("m5b_profile_pairing_e2e")
    finally:
...
def test_joined_harness_uses_only_side_by_side_qa_packages(
    ...
    script._run_gradle(java, android, "private-device", 12345)
    ...
    assert all("uninstall" not in call and "pm clear" not in call for call in calls)
