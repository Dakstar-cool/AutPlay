...
def test_complete_mapping_definition_fingerprint() -> None:
    ...
    assert fingerprint == "2e82492cbf11bf5931ccd3bfeac10673e3004280d2ac161393f3567d613f37c8"
